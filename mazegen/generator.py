...
class MazeGenerator():
    ...
    def __init__(self, config_path: str) -> None:
        """Initialize maze generator attributes from a configuration file.

        Args:
            config_path (str): Path to the maze configuration file.
                The parsed values populate the generator's width, height,
                entry, exit, perfect, output file, and optional seed fields.

        Raises:
            FileNotFoundError: If the configuration file does not exist.
            ValueError: If the config file is malformed or contains invalid
                values.
        """
